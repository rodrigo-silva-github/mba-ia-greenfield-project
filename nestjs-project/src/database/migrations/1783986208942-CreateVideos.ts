...
export class CreateVideos1783986208942 implements MigrationInterface {
  name = 'CreateVideos1783986208942';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "videos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "channel_id" uuid NOT NULL, "title" character varying(255) NOT NULL, "description" text, "status" "public"."videos_status_enum" NOT NULL DEFAULT 'draft', "error_message" text, "storage_key" character varying(1024) NOT NULL, "thumbnail_storage_key" character varying(1024), "upload_id" character varying(255), "duration_seconds" integer, "size_bytes" bigint, "mime_type" character varying(255), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
