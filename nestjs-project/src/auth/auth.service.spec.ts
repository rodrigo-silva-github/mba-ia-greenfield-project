...
describe('AuthService — register', () => {
  ...
  let verificationTokenRepository: MockTokenRepository;
  ...
  beforeEach(async () => {
    ...
    verificationTokenRepository = module.get<MockTokenRepository>(
...
describe('AuthService — login', () => {
  let authService: AuthService;
  let usersService: MockUsersService;
  let refreshTokenRepository: MockTokenRepository;
  ...
  beforeEach(async () => {
    ...
    authService = module.get(AuthService);
    usersService = module.get<MockUsersService>(UsersService);
    refreshTokenRepository = module.get<MockTokenRepository>(
